...
<head>
    ...
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Inicio | Panel de PyMEs</title>
    ...
    <main class="main-container">
        <div class="card-inicio">
            <div class="encabezado-dashboard">
                ...
                <p class="subtitulo-inicio">Bienvenido de nuevo!</p>
            </div>
            ...
            <div class="dashboard-grid">
                ...
                <div class="dash-card">
                    <div class="dash-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="var(--color-secundario)" class="dash-svg">
                    ...
                    <table class="tabla-resumen">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>Laptops Dell XPS</td>
                                <td>+50</td>
                            </tr>
                            <tr>
                                <td>02/07/2026</td>
                                <td><span class="badge badge-salida">Salida</span></td>
